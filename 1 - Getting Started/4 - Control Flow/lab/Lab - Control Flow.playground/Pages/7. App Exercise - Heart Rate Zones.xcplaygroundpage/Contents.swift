...
switch currentHR {
case 100...120:
    print("You are in the Very Light zone. Activity in this zone help with recovery.")
case 121...140:
    print("You are in the Light zone. Activity in this zone helps basic endurance and fat burning.")
case 141...160:
...
case 200...1000:
    print("Be carefull your heart rate beyond the safe zone")
default:
    print("No heart rate monitored")
}

 ...
 */
if let chosenMonth = numberOfDays["January"]
{
    print("January has \(chosenMonth) days")
}
/*:
...
var containerArray : [String : [String]] = ["Shapes" : shapesArray, "Colors": colorsArray]
 ...
 */
let colors = Array(containerArray.values)
let shapes = Array(containerArray.keys)
print(colors[1][2])

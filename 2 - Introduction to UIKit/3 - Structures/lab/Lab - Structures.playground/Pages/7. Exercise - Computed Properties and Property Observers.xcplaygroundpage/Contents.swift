...
var newRectagle = Rectangle(width: 92, height: 12)
print(newRectagle.area)
/*:
...
struct Height {
    ...
    var heightInCentimeters: Double = 0
        ...
        willSet
        {
            print("About to set heightInCentimeters to \(newValue)")
        }
...
var myCarLenght = Height(heightInCentimeters: 12)
print(myCarLenght)
myCarLenght.heightInCentimeters = 250
print(myCarLenght)
myCarLenght.heightInInches = 68
print(myCarLenght)
myCarLenght.heightInCentimeters = 300
print(myCarLenght)

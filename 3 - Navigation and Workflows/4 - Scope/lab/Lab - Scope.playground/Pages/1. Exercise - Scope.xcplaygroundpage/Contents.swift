...
print("foo constant is a local constant can not reach from outside of the for loop")
/*:
...
print("x is a variable and also modified again in a for loop but outside of the loop global version of x will be used.")
/*:
...
greeting(greeting: "Hi there", name: "Kaan")
greeting(greeting: nil, name: "Baylas")
/*:

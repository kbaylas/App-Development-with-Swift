 ...
 */
let firstMac = Computer(ram: 2, yearManufactured: 1984)

if let mac = firstMac
{
    print(mac.ram)
    print(mac.yearManufactured)
}

let firstIBM = Computer(ram: 1, yearManufactured: 1965)

if let ibm = firstIBM
{
    print(ibm.ram)
    print(ibm.yearManufactured)
}
else
{
    print("Your current computer is not enough to run this game.")
}

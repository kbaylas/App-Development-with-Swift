 ...
 */
func add(firstInteger: Int?, secondInteger: Int?) -> Int?
{
    guard let first = firstInteger,
        let second = secondInteger else {return nil}
    
    return first + second
}

add(firstInteger: 4, secondInteger: 6)
add(firstInteger: 5, secondInteger: nil)
add(firstInteger: nil, secondInteger: 3)
add(firstInteger: nil, secondInteger: nil)
/*:
